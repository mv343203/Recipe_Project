package vome.springframework.bootstrap;
...
import vome.springframework.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {//class created to put data into
    ...
    private final CategoryRepository categoryRepository; //variables that are private and name for themselves
    private final RecipeRepository recipeRepository;//these are objects being utilized in this object
    ...
    //constructor injected variables - constructors are called to intialize the object and give it its values
    //here we do dependency injection of the variables and this will create the object
    ...
    private List<Recipe> getRecipes() {//created private method to return this list of recipes upon startup
                                        //<Recipe> means it the list must be of object type recip

        List<Recipe> recipes = new ArrayList<>(2);//create a variable array list with the intial holding c
                                                            //capacity of 2 recipes
                                                           // going to be return object for the method
